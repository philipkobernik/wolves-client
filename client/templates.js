(function (root, factory) {
    ...
    templatizer["pages"]["home"] = function tmpl_pages_home() {
        return '<section class="page howls"><h1>HOME</h1></section>';
    };

    // pages/howls.jade compiled template
    templatizer["pages"]["howls"] = function tmpl_pages_howls() {
        return '<section class="page howls"><h2>Howls</h2><form><input data-hook="howl-input" placeholder="awoooooooo"/></form><div data-hook="howls-container"></div></section>';
    };
